...
public class PriorityBlockingQueue<E> extends AbstractQueue<E>
     ...
     * 优先队列是一个平衡二叉堆：queue[n]的两个儿子是queue[2*n+1]和queue[2*(n+1)]。
     * 优先队列通过comparator排序，或者当comparator为null时为元素的自然排序：堆中结点大于它下方的结点，
     * 最小的是queue[0]
     */
     ...
     * 将x插入到位置k，通过对x循环降级直到它小于它的儿子或者它成为了叶子来保持堆的不变性
     *
     * @param k the position to fill
     * @param x the item to insert
     * @param array the heap array
