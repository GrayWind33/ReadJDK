...
public class ArrayBlockingQueue<E> extends AbstractQueue<E>
    ...
    /** The queued items队列元素 */
    final Object[] items;

    /** items index for next take, poll, peek or remove下一个出队的元素 */
    int takeIndex;

    /** items index for next put, offer, or add下一个入队的位置 */
    int putIndex;

    /** Number of elements in the queue队列中的元素 */
    int count;
