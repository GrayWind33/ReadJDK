 ...
 * 对一个long值进行原子性跟新。看java.util.concurrent.atomic包关于原子性变量属性的详细描述。
 * AtomicLong被用于原子性增长的序列值，但不能用来替代java.lang.Long。
 * 然而，这个类扩展了Number允许工具类统一访问来解决采用数字的类。
 *
 * @since 1.5
 * @author Doug Lea
 */
public class AtomicLong extends Number implements java.io.Serializable {
     ...
     * 如果当前value==expect，则原子性的更新value为update，返回是否操作成功
     *
